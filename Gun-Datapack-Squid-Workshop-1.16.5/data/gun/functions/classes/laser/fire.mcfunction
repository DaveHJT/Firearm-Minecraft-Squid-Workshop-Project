#powered model
execute if entity @s[scores={shift=0},nbt={SelectedItem:{tag:{CustomModelData:519}}}] run replaceitem entity @s weapon.mainhand minecraft:carrot_on_a_stick{CustomModelData:521,display:{Name:"{\"text\":\"laser rifle\"}"},gun:1b,laser:1b,silenced:0}

execute if entity @s[scores={shift=1..}] run replaceitem entity @s weapon.mainhand minecraft:carrot_on_a_stick{CustomModelData:522,display:{Name:"{\"text\":\"laser rifle aiming\"}"},gun:1b,laser:1b,silenced:0}
