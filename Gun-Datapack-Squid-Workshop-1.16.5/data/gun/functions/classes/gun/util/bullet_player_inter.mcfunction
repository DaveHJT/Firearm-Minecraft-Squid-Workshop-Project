...
#hitbox
execute if entity @s[tag=!reflected_b] run execute positioned ~ ~-0.975 ~ positioned ^ ^ ^0.5 as @e[tag=lp,distance=0..1.14,tag=!hit,tag=!own,nbt={Age:2}] run function gun:classes/gun/util/hitbox_p
