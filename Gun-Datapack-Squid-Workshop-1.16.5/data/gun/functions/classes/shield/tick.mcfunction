...
execute as @a[tag=shielding,tag=!shift_bool] at @s positioned ~ ~1.6 ~ run tp @e[tag=shield,limit=1,sort=nearest] ^ ^-1.1 ^1
execute as @a[tag=shielding,tag=shift_bool] at @s positioned ~ ~1.3 ~ run tp @e[tag=shield,limit=1,sort=nearest] ^ ^-1.1 ^1
