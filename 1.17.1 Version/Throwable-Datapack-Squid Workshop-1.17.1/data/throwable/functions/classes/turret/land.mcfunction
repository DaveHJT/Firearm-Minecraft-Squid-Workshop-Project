...
#skin
item replace entity @e[limit=1,sort=nearest,tag=turret_effect,type=armor_stand] armor.head with minecraft:stone_button{CustomModelData:510,Private:1b}
item replace entity @e[limit=1,sort=nearest,tag=turret_effect,type=armor_stand] weapon.mainhand with minecraft:stone_button{CustomModelData:513,Private:1b}
item replace entity @e[limit=1,sort=nearest,tag=turret_effect,type=!armor_stand] armor.head with minecraft:stone_button{CustomModelData:520,Private:1b }
