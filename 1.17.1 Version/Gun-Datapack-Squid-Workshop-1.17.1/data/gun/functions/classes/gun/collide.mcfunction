...
execute unless block ~ ~ ~ #gun:air run scoreboard players set v15 V 1
...
execute if score v1 V matches 1.. if score v7 V <= v13 V if score v7 V <= v8 V if score v7 V <= v9 V if block ~1 ~ ~ #gun:solid run scoreboard players operation v13 V = v7 V
execute if score v1 V matches ..1 if score v7 V <= v13 V if score v7 V <= v8 V if score v7 V <= v9 V if block ~-1 ~ ~ #gun:solid run scoreboard players operation v13 V = v7 V

execute if score v2 V matches 1.. if score v8 V <= v13 V if score v8 V <= v7 V if score v8 V <= v9 V if block ~ ~1 ~ #gun:solid run scoreboard players operation v13 V = v8 V
execute if score v2 V matches ..1 if score v8 V <= v13 V if score v8 V <= v7 V if score v8 V <= v9 V if block ~ ~-1 ~ #gun:solid run scoreboard players operation v13 V = v8 V

execute if score v3 V matches 1.. if score v9 V <= v13 V if score v9 V <= v7 V if score v9 V <= v8 V if block ~ ~ ~1 #gun:solid run scoreboard players operation v13 V = v9 V
execute if score v3 V matches ..1 if score v9 V <= v13 V if score v9 V <= v7 V if score v9 V <= v8 V if block ~ ~ ~-1 #gun:solid run scoreboard players operation v13 V = v9 V
