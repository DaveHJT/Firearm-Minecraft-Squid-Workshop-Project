...
execute if score @s aim matches 2 run item replace entity @s weapon.mainhand with minecraft:carrot_on_a_stick{CustomModelData:518,display:{Name:"{\"text\":\"sniper rifle aiming\"}"},gun:1b,sniper:1b,silenced:0}
