#powered model
execute if entity @s[scores={shift=0},nbt={SelectedItem:{tag:{CustomModelData:519}}}] run item replace entity @s weapon.mainhand with minecraft:carrot_on_a_stick{CustomModelData:521,display:{Name:"{\"text\":\"laser rifle\"}"},gun:1b,laser:1b,silenced:0}

execute if entity @s[scores={shift=1..}] run item replace entity @s weapon.mainhand with minecraft:carrot_on_a_stick{CustomModelData:522,display:{Name:"{\"text\":\"laser rifle aiming\"}"},gun:1b,laser:1b,silenced:0}
