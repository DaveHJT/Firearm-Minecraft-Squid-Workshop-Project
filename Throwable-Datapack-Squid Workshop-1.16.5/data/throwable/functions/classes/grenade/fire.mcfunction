...
summon minecraft:area_effect_cloud ~ ~0.5 ~ {Duration:2,Tags:["bullet","new_b","grenade"]}
...
#damage
execute as @e[tag=new_b,limit=1,sort=nearest] run scoreboard players set @s damage 11
