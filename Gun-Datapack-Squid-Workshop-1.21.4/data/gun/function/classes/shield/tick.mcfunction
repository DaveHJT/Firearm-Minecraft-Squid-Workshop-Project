...
tag @a[scores={shield_hold=1},tag=!shielding] add shieldon
...
tag @a[scores={shield_hold=1}] add shielding
...
tag @a[tag=shielding,scores={shield_hold=0}] add shieldoff
...
tag @a[tag=shielding,scores={shield_hold=0}] remove shielding