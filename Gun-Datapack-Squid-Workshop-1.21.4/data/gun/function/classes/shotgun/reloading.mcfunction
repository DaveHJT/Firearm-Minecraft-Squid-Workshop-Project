...
execute if score @s reload matches 32 run playsound minecraft:gun/m4a1/m4a1_cliphit player @a ~ ~ ~ 0.5 0.7
$execute if score @s reload matches 0 run function gun:classes/$(key)/reloading/complete_from_$(mode)
