...
execute as @s[scores={carotClik_bool=0,cooldown=0,aim=0,shift=0,r_cooldown=0}] if items entity @s weapon.mainhand *[custom_data~{key:"laser"},custom_model_data={strings:["laser_powered"]}] run item modify entity @s weapon.mainhand gun:classes/laser/powered_clear