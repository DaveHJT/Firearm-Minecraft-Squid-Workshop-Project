...
scoreboard players operation v0 V = @s spread
scoreboard players operation v0 V *= v0 V
execute store result storage firearm:storage arg.max int 10 run scoreboard players get v0 V
execute store result storage firearm:storage arg.min int -10 run scoreboard players get v0 V
