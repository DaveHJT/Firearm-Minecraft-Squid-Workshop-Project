...
execute at @s as @e[type=area_effect_cloud,tag=spread_calculator,sort=nearest,limit=1] run function gun:classes/gun/spread/get_facing with storage firearm:storage arg
