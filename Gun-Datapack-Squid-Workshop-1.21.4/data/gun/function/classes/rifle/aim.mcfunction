...
execute if score @s aim matches 2 run item replace entity @s weapon.mainhand with minecraft:carrot_on_a_stick[CustomModelData:510,display:{Name:"{\"text\":\"auto rifle\"}"},custom_data={gun:1b,rifle:1b,silenced:0}]
