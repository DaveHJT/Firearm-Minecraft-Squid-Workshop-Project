...
#skin
item replace entity @e[limit=1,sort=nearest,tag=turret_effect,type=armor_stand] armor.head with minecraft:iron_nugget[custom_model_data={strings:["turret_head_g"]}, item_name='{"text":"turret_head_g"}', custom_data={private:1b}]
item replace entity @e[limit=1,sort=nearest,tag=turret_effect,type=armor_stand] weapon.mainhand with minecraft:iron_nugget[custom_model_data={strings:["turret_body_folded"]}, item_name='{"text":"turret_body_folded"}', custom_data={private:1b}]
item replace entity @e[limit=1,sort=nearest,tag=turret_effect,type=!armor_stand] armor.head with minecraft:iron_nugget[custom_model_data={strings:["turret_head_g_mob"]}, item_name='{"text":"turret_head_g_mob"}', custom_data={private:1b}]
