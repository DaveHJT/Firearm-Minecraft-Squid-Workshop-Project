# turn red
item replace entity @s[type=armor_stand] armor.head with minecraft:iron_nugget[custom_model_data={strings:["turret_head_r"]}, item_name='{"text":"turret_head_r"}']
item replace entity @s[type=!armor_stand] armor.head with minecraft:iron_nugget[custom_model_data={strings:["turret_head_r_mob"]}, item_name='{"text":"turret_head_r_mob"}']
tag @s remove green
