...
execute if entity @s[tag=!green,type=armor_stand,tag=!target_aimed] run item replace entity @s armor.head with minecraft:iron_nugget[custom_model_data={strings:["turret_head_g"]}, item_name='{"text":"turret_head_g"}']
execute if entity @s[tag=!green,type=!armor_stand,tag=!target_aimed] run item replace entity @s armor.head with minecraft:iron_nugget[custom_model_data={strings:["turret_head_g_mob"]}, item_name='{"text":"turret_head_g_mob"}']
