summon item ~ ~ ~ {Item:{id:"minecraft:snowball",components:{custom_model_data:{strings:["flash"]}, item_name:'{"text":"flashbang"}'}},PickupDelay:32767s,Tags:["flash_effect","effect"]}
