summon item ~ ~ ~ {Item:{id:"minecraft:snowball",Count:1b,tag:{custom_model_data:{strings:["molotov"]}, item_name:'{"text":"molotov"}'}},PickupDelay:32767s,Tags:["molotov_effect","effect"],Invulnerable:1b,Fire:100s}
