summon item ~ ~ ~ {Item:{id:"minecraft:snowball",Count:1b,tag:{custom_model_data:{strings:["flash"]}, item_name:'{"text":"flashbang"}'}},PickupDelay:32767s,Tags:["flash_effect","effect"]}
