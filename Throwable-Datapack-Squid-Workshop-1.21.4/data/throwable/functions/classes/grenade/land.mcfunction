#summon item ~ ~ ~ {Item:{id:"minecraft:snowball",Count:1b,tag:{custom_model_data:{strings:["grenade"]}, item_name:'{"text":"grenade"}'}},PickupDelay:32767s,Tags:["grenade_effect","effect"]}

summon armor_stand ~ ~ ~ {Tags:["grenade_effect","effect"],Invisible:1b,Marker:1b}

summon item ~ ~ ~ {Item:{id:"minecraft:snowball",Count:1b,tag:{custom_model_data:{strings:["grenade"]}, item_name:'{"text":"grenade"}'}},PickupDelay:32767s,Tags:["display"]}
