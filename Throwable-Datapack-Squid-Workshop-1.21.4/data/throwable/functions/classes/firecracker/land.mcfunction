summon item ~ ~ ~ {Item:{id:"minecraft:snowball",Count:1b,tag:{custom_model_data:{strings:["firecracker"]}, item_name:'{"text":"firecracker"}'}},PickupDelay:32767s,Tags:["firecracker_effect","effect"]}
