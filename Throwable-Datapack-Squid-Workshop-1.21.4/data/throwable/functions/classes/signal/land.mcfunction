summon item ~ ~ ~ {Item:{id:"minecraft:snowball",Count:1b,tag:{custom_model_data:{strings:["signal"]}, item_name:'{"text":"signal flare"}'}},PickupDelay:32767s,Tags:["signal_effect","effect"]}
