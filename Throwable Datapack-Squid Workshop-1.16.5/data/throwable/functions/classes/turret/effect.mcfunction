...
execute if entity @s[tag=!green,type=armor_stand] unless entity @s[tag=target_aimed] run replaceitem entity @s armor.head minecraft:stone_button{CustomModelData:510}
execute if entity @s[tag=!green,type=!armor_stand] unless entity @s[tag=target_aimed] run replaceitem entity @s armor.head minecraft:stone_button{CustomModelData:520}
