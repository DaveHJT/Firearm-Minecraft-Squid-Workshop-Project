...
#model
execute if score @s throwable_life matches 10 run replaceitem entity @s[type=armor_stand] weapon.mainhand minecraft:stone_button{CustomModelData:512}
...
#execute if score @s throwable_life matches 10 run replaceitem entity @s[type=zombie] weapon.mainhand minecraft:stone_button{CustomModelData:522}
