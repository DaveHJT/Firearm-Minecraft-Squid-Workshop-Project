...
summon minecraft:area_effect_cloud ^ ^ ^0.4 {Duration:10,Tags:["bullet","b_shot","new_b","slow"]}
...
#damage
execute as @e[tag=new_b,limit=1,sort=nearest] run scoreboard players set @s damage 17
