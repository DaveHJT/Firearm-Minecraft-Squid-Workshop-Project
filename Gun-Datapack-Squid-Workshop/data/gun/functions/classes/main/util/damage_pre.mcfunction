...
execute store result score v0 V run data get entity @s Attributes[4].Base
...
#execute store result score v1 V run data get entity @s Attributes[4].Modifiers[0].Amount
...
execute if entity @s[gamemode=!creative,gamemode=!spectator] if score v0 V >= v2 V run function gun:classes/main/util/damage_lethal
#execute if score showDeath V matches 0 if score v0 V >= v2 V run function gun:classes/main/util/damage_lethal_simp

execute if entity @s[gamemode=!creative,gamemode=!spectator] if score v0 V < v2 V run function gun:classes/main/util/damage_nonlethal
