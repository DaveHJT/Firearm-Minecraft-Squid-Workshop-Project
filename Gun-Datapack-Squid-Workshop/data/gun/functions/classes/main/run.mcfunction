...
execute as @a[tag=damaged] run function gun:classes/main/util/damage_post
...
#post damage
execute as @e[type=#gun:supported,scores={damage=1..}] at @s run function gun:classes/main/util/mob_damage
execute as @a[scores={damage=1..,health=1..},tag=!damage_buffer] run function gun:classes/main/util/damage_pre
