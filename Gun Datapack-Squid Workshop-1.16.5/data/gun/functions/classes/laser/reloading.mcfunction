...
execute if entity @s[scores={b_energy=20..}] run replaceitem entity @s weapon.offhand minecraft:carrot_on_a_stick{CustomModelData:521,display:{Name:"{\"text\":\"laser rifle\"}"},gun:1b,laser:1b,silenced:0}
