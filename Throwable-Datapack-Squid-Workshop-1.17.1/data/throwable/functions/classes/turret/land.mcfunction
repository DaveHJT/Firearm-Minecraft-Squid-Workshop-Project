...
#skin
item replace entity @e[limit=1,sort=nearest,tag=turret_effect,type=armor_stand] armor.head with minecraft:iron_nugget{CustomModelData:510,Private:1b}
item replace entity @e[limit=1,sort=nearest,tag=turret_effect,type=armor_stand] weapon.mainhand with minecraft:iron_nugget{CustomModelData:513,Private:1b}
item replace entity @e[limit=1,sort=nearest,tag=turret_effect,type=!armor_stand] armor.head with minecraft:iron_nugget{CustomModelData:520,Private:1b }
